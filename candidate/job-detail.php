...
<body>
    <div class="container-xxl bg-white p-0">
        ...
        if (isset($_GET['jobId'])) {
            $id = $_GET['jobId']; 
                $q_get_job_details= "SELECT * FROM jobs WHERE `id`=$id and is_expired=0
                ORDER BY id DESC";
                ...
                <div class="row gy-5 gx-4">
                    ...
                    <div class="col-lg-4">
                        <div class="bg-light rounded p-5 mb-4 wow slideInUp" data-wow-delay="0.1s">
                            ...
                            <p><i class="fa fa-angle-right text-primary me-2"></i>Published On:<?php echo $row['starting_date']; ?></p>
                            <p><i class="fa fa-angle-right text-primary me-2"></i>Vacancy: <?php echo $row['nof_employee']; ?> Position</p>
                            <p><i class="fa fa-angle-right text-primary me-2"></i>Job Nature: <?php echo $row['nature']; ?></p>
                            <p><i class="fa fa-angle-right text-primary me-2"></i>Salary: <?php echo $row['salary_rate']; ?></p>
                            <p><i class="fa fa-angle-right text-primary me-2"></i>Location: <?php echo $row['location']; ?></p>
                            <p class="m-0"><i class="fa fa-angle-right text-primary me-2"></i>Date Line: <?php echo $row['starting_date']; ?></p>
                        </div>

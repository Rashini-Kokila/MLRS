...
<body>
    <div class="container-xxl bg-white p-0">
        ...
        <div class="container-fluid p-0">
            <div class="owl-carousel header-carousel position-relative">
                <div class="owl-carousel-item position-relative">
                    <img class="img-fluid" src="img/pic-2.jpg" alt="">
                        ...
                        <div class="container">
                            <div class="row justify-content-start">
                                <div class="col-10 col-lg-8">
                                    ...
                                    <a href="candidate/jobseeker_main.php" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">Search A Job</a>
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-sm-12 col-md-4 d-flex flex-column align-items-start align-items-md-end justify-content-center">
                                    <div class="d-flex mb-3">
                                        ...
                                        <a class="btn btn-primary" href="candidate/jobseeker_main.php">Apply Now</a>
                                    </div>
        ...
        <div class=" d-flex justify-content-center align-items-center">
            <a class="btn btn-primary py-3 px-5" href="candidate/jobseeker_main.php">Upload your resume</a>
        </div>
        <!-- Search End -->
